...
class YahooEquityDataAnalyser:
    ...
    def get_daily_returns(symbol, dates):
        ...
        data_record = models.HistoricalPrice.select().where((models.HistoricalPrice.symbol == symbol)
                                                            ...
                                                            & (
                                                                models.HistoricalPrice.transaction_date <= max_date)).order_by(
    ...
    def get_index_relative_average_between_two_days(self, symbols, begin_date, end_date):
        returns = self.get_index_relative_returns_between_two_days(symbols, begin_date, end_date)
